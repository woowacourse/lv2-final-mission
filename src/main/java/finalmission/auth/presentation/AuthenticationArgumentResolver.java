...
import finalmission.exception.auth.AuthenticationRequiredException;
...
public class AuthenticationArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterAnnotation(finalmission.auth.presentation.Authenticated.class) != null &&
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        String memberId = tokenProvider.extractMemberId(token);
        try {

...
- [x] 담당 선생님을 지정한다
- [ ] 내 담당 선생님의 예약 현황을 확인한다
- [ ] 수업을 예약한다
    - [ ] 내 담당 선생님의 수업만 예약할 수 있다
    - [ ] 남은 PT 횟수가 있어야 예약할 수 있다
    - [ ] 예약에 성공하면 PT 횟수가 1회 차감된다
    - [ ] 이미 예약된 시간대라면 예약 대기로 등록된다
        - [ ] 이 때 PT 횟수는 차감되지 않는다
- [ ] 수업 예약을 취소한다
    - [ ] 수업을 취소하면 PT 횟수가 복구된다
    - [ ] 수업 하루 전부터 수업을 취소해도 PT 횟수가 복구되지 않는다
    - [ ] 수업 시간 이후로 예약을 취소할 수 없다
- [ ] 수업 대기를 취소한다
    - [ ] 수업 대기는 기간에 상관없이 취소할 수 있다
- [ ] 내 예약과 대기 현황을 확인한다